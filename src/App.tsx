...
// Substitua a configuração do QueryClient no início do App.tsx
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // Remova todas as outras configurações (staleTime, gcTime, etc)
      // e use apenas estas duas
...
// Adicione esta linha APÓS criar o queryClient
// @ts-expect-error - ignorar erro de TypeScript
window.__REACT_QUERY_ALLOW_PREFETCH_IN_RENDER__ = true;
